package ru.otus.vinakov.calendar.migration;
...
public class V1_InitCalendar_RU_2026 {
    ...
    public void initCalendar2026() {
        ...
        List<ProductionCalendarDay> holidays = Arrays.asList(
                ...
                // 1 мая (перед ним сокращенный)
//                new ProductionCalendarDay(LocalDate.of(2026, 4, 27), DayType.REDUCED), // Сокращенный день перед 1 мая
                ...
                new ProductionCalendarDay(LocalDate.of(2026, 5, 11), DayType.WEEKEND), // Предпраздничный, если 9 мая падает на выходной

                // 12 июня
                new ProductionCalendarDay(LocalDate.of(2026, 6, 12), DayType.WEEKEND),

                // 4 ноября (перед ним сокращенный)
//                new ProductionCalendarDay(LocalDate.of(2026, 11, 3), DayType.REDUCED),
                new ProductionCalendarDay(LocalDate.of(2026, 11, 4), DayType.WEEKEND)

                // Сокращенный перед Новым годом
//                new ProductionCalendarDay(LocalDate.of(2026, 12, 31), DayType.REDUCED)
        );
