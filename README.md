...
* Сервис calendar позволяет задавать производственный календарь с учетом выходных и сокращенных дней для корректного посчета по временным метрикам с учетом рабочего дня и рабочих периодов
